  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-zinc-700 bg-[linear-gradient(180deg,#27272a,#18181b)] px-8 py-6 md:w-[450px] shadow-lg"
            key={idx}
          >
            <blockquote>
              <div
